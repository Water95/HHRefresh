#
#  Be sure to run `pod spec lint HHRefresh.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "haohaisheng"
  # s.authors            = { "haohaisheng" => "haohaisheng95@163.com" }
  # s.social_media_url   = "http://twitter.com/haohaisheng"
