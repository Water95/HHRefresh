...
typedef  NS_ENUM(NSInteger,HHFooterRefreshState){
    HHFooterRefreshStateNormal  = 1,     //正常,上拉加载更多（点击加载更多）
    HHFooterRefreshStatePulling,         //释放可以刷新的状态
    HHFooterRefreshStateRefreshing,      //正在刷新中的状态
    HHFooterRefreshStateWillRefreshing,  //即将进入刷新的状态
    HHFooterRefreshStateNoMoreData,      //没有更多数据的状态
};
